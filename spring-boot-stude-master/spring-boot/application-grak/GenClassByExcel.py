...
javaSourceTemplate = """
 ...
 import com.grak.study.xlsx.Sample;
 import com.grak.study.xlsx.SampleFactory;
 import com.grak.study.xlsx.SampleFactoryImpl;
...
"""
topackage = "com.grak.study.xlsx.sample"
...
class JavaSourceTemplate:
    ...
    def genJavaSource(self):
        ...
        return javaSourceTemplate % (
            ...
            self.factorySrc,
            self.className, self.className, self.className, self.className, self.className, self.className,self.className,
            strFields)
